...
@Component({
  selector: 'app-report-customer-account-top',
  templateUrl: './report-customer-account-top.component.html',
})
export class ReportCustomerAccounToptComponent implements OnInit {
  ...
  returnUrlAddress:any='/index-info';
   ...
   columns = [              
    ...
    {
      dataField:"accountCountSender",
      alignment:"center",
        caption:"ارسالی",
    },
    {
      dataField:"accountCountReciver",
      alignment:"center",
      caption:"دریافتی",
    },
    {
      dataField:"accountCountAll",
      alignment:"center",
      caption:"همه",
    },
    {
  ...
  ngOnInit() {    
    this.configSearch = {
      ...
      this.titlelist = "لیست 20 مشتری برگزیده"; // this.translate.instant('individual-customer-account-report');// this.tranlate.instant("report.transaction.title");
  }
  ...
  onPrint(){
    ...
    popupWin.document.write(`
      <html dir='rtl' >
        <head>
          <title>لیست 20 مشتری برگزیده</title>
  ...
  onSearchReport(model:ReportSearchAccountDto){
    ...
    this.crudService.postDataUrl(Globals.UrlTransactionReport, "reportCustomerAccountTop", model).subscribe(res=>{
