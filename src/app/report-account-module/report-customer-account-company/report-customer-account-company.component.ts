...
@Component({
  selector: 'app-report-customer-account-company',
  templateUrl: './report-customer-account-company.component.html',
})
export class ReportCustomerAccountCompanyComponent implements OnInit {
  ...
  returnUrlAddress:any='/index-info';
   ...
   columns = [           
    ...
    //   caption: this.tranlate.instant('customer.list.picture'),
    ...
    },
    {
      dataField:"bossTitle",
      alignment:"center",
        caption:this.translate.instant('boss'),
    },
    {
      dataField:"deputyTitle",
      alignment:"center",
        caption:this.translate.instant('deputy'),
    },
    {
      dataField:"licenseTitle",
      alignment:"center",
        caption:this.translate.instant('license'),
    },   
  ];
  ...
  ngOnInit() {    
    this.configSearch = {
      ...
      this.titlelist =this.translate.instant('legal-customer-account-report-(legal)');// this.tranlate.instant("report.transaction.title");
  }
  ...
  onSearchReport(model:ReportSearchAccountDto){
    ...
    this.crudService.postDataUrl(Globals.UrlTransactionReport, "reportCustomerAccountCompany", model).subscribe(res=>{
