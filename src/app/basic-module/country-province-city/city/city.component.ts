...
export class CityComponent implements OnInit {
  ...
  dataProvince : CountryProvinceCityDto[]=[];  
  ...
  columns = [{
    ...
    ngOnInit() {
        this.titlelist = this.translate.instant('list-of-countys')
    this.getProvince(); 
    this.get();
  ...
  openDialogForm() {
    const activeModal = this.modalService.open(CityFormComponent);
    activeModal.componentInstance.model = Object.assign({},  this.model);
    activeModal.componentInstance.countryProvinceCitis = this.dataProvince;
  ...
  private get(){
    ...
    this.crudService.getDataUrl(this.baseUrlApi, `getCity`).subscribe(res=>{
      this.datasource = res ;    
  ...
  private getProvince(){
    this.crudService.getDataUrl(this.baseUrlApi, `getProvince`).subscribe(res=>{
