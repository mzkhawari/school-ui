...
export class ProvinceComponent implements OnInit {
  ...
  private _unsubscribeAll: Subject<any> = new Subject<any>();
    ...
    ngOnInit() {
        this.titlelist = this.translate.instant('list-of-provinces');
    this.get();
    this.getZone();
  ...
  openDialogForm() {
    const activeModal = this.modalService.open(ProvinceFormComponent, { panelClass: 'search-filter-panel-modal', });
