...
export class NotificationsComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
     ...
     if (!this.dataValue) {
        ...
        // const notifyList = new Observable((observer) => {
        //     let CountInfo: number;
        //     this.splashScreenService.show();
        //     this.crudService.getDataUrl(Globals.UrlTransaction, "GetNewTransaction").subscribe(res => {
        //     this.splashScreenService.hide();
        //     this.dataValue = res;
        //     this.unreadCount = CountInfo = this.dataValue.length;
        //     observer.next(this.unreadCount);
        //     },
        //     error => {
        ...
        //   const notifyBugest = notifyList.subscribe({
        //     next(dataCount) {
        //         this.unreadCount = dataCount
        //     },
        //     error(msg) {
        //       console.log('', msg);
        //     }
    ...
    private getItem() {
        ...
        this.crudService.getDataUrl(Globals.UrlTransactionReport, `GetNewTransaction/${(this.isFirstTime?0:1)}`).subscribe(res => {
            if(this.isFirstTime){
            ...
            if(this.refreshCounter){
                const notify: any = document.querySelector("#nofiyCount");
                if (notify != null)
                    notify.click();
                this.closePanel();
            }
