...
@Component({
    selector       : 'account-license-expired-notify',
    templateUrl    : './account-license-expired-notify.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'account-license-expired-notify'
})
export class AccountLicenseExpiredNotifyComponent implements OnInit, OnDestroy
{
    ...
    private getItem() {
        ...
        this.crudService.getDataUrl(Globals.UrlApplicantReport, `getExpiredLicesenceAccount/${(this.isFirstTime?0:1)}`).subscribe(res => {
            if(this.isFirstTime){
            ...
            if(this.refreshCounter){
                const notify: any = document.querySelector("#nofiyAcoountLicenseExpired");
                if (notify != null)
                    notify.click();
                this.closePanel();
            }
