...
export class LanguagesComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        if (this.activeLang == "fa") {
            this.activeLangLabel = 'فارسی';// this.translate.instant("language.fa");
        }
        // else if (this.activeLang == "pa") {
        //     this.activeLangLabel = this.translate.instant("language.pa");
        // }
        // else if (this.activeLang == "en") {
        //     this.activeLangLabel = this.translate.instant("language.en");
        // }
