...
@Component({
    selector       : 'app-tranaction-suspicious-notify',
    templateUrl    : './tranaction-suspicious-notify.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'app-tranaction-suspicious-notify'
})
export class TranactionSuspiciousNotifyComponent implements OnInit, OnDestroy
{
    ...
    private getItem() {
        this.crudService.getDataUrl(Globals.UrlTransactionSuspiciousReport, `GetNewTransactionSuspicious/${this.type}`).subscribe(res => {
            this.isFirstTime = this.refreshCounter = this.unreadCount==0;
            if(this.type==0){
                this.unreadCount = res.count ;// this.dataValue.length;
            }else{
