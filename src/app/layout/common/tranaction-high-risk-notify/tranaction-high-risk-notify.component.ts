...
@Component({
    selector       : 'app-tranaction-high-risk-notify',
    templateUrl    : './tranaction-high-risk-notify.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'app-tranaction-high-risk-notify'
})
export class TranactionHighRiskNotifyComponent implements OnInit, OnDestroy
{
    ...
    private getItem() {
        ...
        this.crudService.getDataUrl(Globals.UrlTransactionReport, "reportTrnRiskNotify").subscribe(res => {
          this.splashScreenService.hide();
          this.dataValue = res.data;
          this.unreadCount = res.dataCount;
            const notify: any = document.querySelector("#nofiyTransactionHighRisk");
            if (notify != null)
                notify.click();
          this.closePanel();    
        },
