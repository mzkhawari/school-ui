...
@Component({
    selector       : 'branch-min-treasury-notify',
    templateUrl    : './branch-min-treasury-notify.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'branch-min-treasury-notify'
})
export class BranchMinTreasuryNotifyComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        .withAutomaticReconnect([15000,30000,45000,60000]) //30000,45000,60000
    ...
    private getItem() {
        ...
        this.crudService.getDataUrl(Globals.UrlBranchReport, `geMinTreasuryBranch/${(this.isFirstTime?0:1)}`).subscribe(res => {
            if(this.isFirstTime){
            ...
            if(this.refreshCounter){
                ...
                const notify:any = document.querySelector("#nofiyBranchMinTreasury");
                notify.click();
                this.closePanel();
            }
        },
