...
import { defaultNavigation } from 'app/mock-api/common/navigation/data-fa';
import { defaultNavigation_pa } from 'app/mock-api/common/navigation/data-pa';
import { defaultNavigation_en } from 'app/mock-api/common/navigation/data-en';
...
export class SearchMockApi
{
    ...
    private readonly _defaultNavigation_pa: FuseNavigationItem[] = defaultNavigation_pa;
    private readonly _defaultNavigation_en: FuseNavigationItem[] = defaultNavigation_en;
    ...
    registerHandlers(): void
    {
        ...
        let flatNavigation:FuseNavigationItem[] ;
         if (lang =='fa'){
            flatNavigation = this._fuseNavigationService.getFlatNavigation(this._defaultNavigation);
         }else if (lang =='pa'){
            flatNavigation = this._fuseNavigationService.getFlatNavigation(this._defaultNavigation_pa);
        }else if (lang =='en'){
            flatNavigation = this._fuseNavigationService.getFlatNavigation(this._defaultNavigation_en);
        }else{
            flatNavigation = this._fuseNavigationService.getFlatNavigation(this._defaultNavigation);
        }
